import { Vector3, MeshBuilder,Mesh, SolidParticleSystem, Quaternion, Axis } from "@babylonjs/core"

//creates an x, y, z coordinate system using the parameter vec3 for the y axis
export const coordSystem = function(vec3) {  //vec3 non-zero Vector3
...
export const randPct = function(v, p) {
	if(p==0) {
		return v;
	}
...
*/
export const createBranch = function(branchAt, branchSys, branchLength, branchTaper, branchSlices, bowFreq, bowHeight, branchRadius, scene) {          
...
*/
export const createTreeBase = function(trunkHeight, trunkTaper, trunkSlices, boughs, forks, forkAngle, forkRatio, bowFreq, bowHeight, scene) {   
...
*/
export const createTree = function(trunkHeight, trunkTaper, trunkSlices, trunkMaterial, boughs, forks, forkAngle, forkRatio, branches, branchAngle, bowFreq, bowHeight, leavesOnBranch, leafWHRatio, leafMaterial, scene) {        
